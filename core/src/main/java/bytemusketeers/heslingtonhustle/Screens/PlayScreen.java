...
public class PlayScreen implements Screen {
    ...
    public PlayScreen(HeslingtonHustle game){
        ...
        for (int i = 0; i < studyItems.length; i++) {
            //float
            randomX = MathUtils.random(0, HeslingtonHustle.W_WIDTH / HeslingtonHustle.PPM);
            //float
            randomY = MathUtils.random(0, HeslingtonHustle.W_HEIGHT / HeslingtonHustle.PPM);
    ...
    public void handleInput(){
        ...
        //test for reaching the EndScreen
