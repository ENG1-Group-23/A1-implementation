...
class DesktopLauncher {
    ...
    /**
     * The frames-per-second limit, fixed to ensure a consistent {@link bytemusketeers.heslingtonhustle.scene.Character}
     * move-speed across differing monitor refresh rates.
     */
